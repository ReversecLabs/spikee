...
| **AWS Bedrock** | `bedrock-`<br/>`bedrockcv-` | `bedrock-claude37-sonnet`<br/>`bedrock-deepseek-v3`<br/>`bedrock-qwen3-coder-30b-a3b-v1`<br/><small>*(Allows internal shorthands)*</small> | `AWS_ACCESS_KEY_ID`<br/>`AWS_SECRET_ACCESS_KEY`<br/>`AWS_DEFAULT_REGION` | [Models List](https://docs.aws.amazon.com/bedrock/latest/userguide/models-supported.html) |
