...
```bash
spikee generate --seed-folder datasets/seeds-cybersec-2026-01 --languages en
```
...
```bash
spikee generate --seed-folder datasets/seeds-cybersec-2026-01 --languages en --include-system-message --spotlighting-data-markers $'\n<data>\nDOCUMENT\n</data>\n',$'\n{"document":"DOCUMENT"}\n'
```
